...
DEFAULT_WELCOME_MESSAGES = [
    "{first} Xoş  Geldin",  #Discord welcome messages copied
    "Salam {first} Dostluğun, hörmətin və sayqının kəsişdiyi qrupumuzda sizi görmək bizim üçün çox xoş oldu.",
    "Uşaqlar, {first} Artıq Bizimlədir.",
    "Kimleri Görürük! {first} Xoş Gəldin.",
    "{first} Aslan kimi geldi!",
    "{first} Partimize Qoşuldu.",
    "Salam, {first}. Biraz Dincəl Və Söhbətimizə Qatıl ( ͡° ͜ʖ ͡°)",
    "{first}, bu asan bir missiya olmayacaq burda yalnız aktivler olur!",  #End of Jumanji stuff
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first} getdi...",
    "{first} artıq bizlə olmuyacaq!",
    "{first} səni gözliyeceyik dost!.",
    "{first} bizi tərk etdi...",
    "{first} Yaxşı Yol!.",
]
